...
**最新デプロイ**: Collector rev 00023-w7s（立替金シート収集対応）+ Dashboard rev 00225-jjs（振込CSV出力追加）※ #55 未デプロイ
...
**WAM Must要件 3/3 完了**。残りはWant要件とインフラ改善。

1. **デプロイ**: #55 支払明細書PDF（PR #86）の Dashboard デプロイ
...
5. **未追跡ファイル整理** — ルートのスクリーンショットPNG 10件 + `.serena/`
