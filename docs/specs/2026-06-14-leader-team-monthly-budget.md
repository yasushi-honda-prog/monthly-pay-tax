...
| AC9 | `invalidate_all(fiscal_year)` で **影響先 5 cache 関数** clear (cached_fetch_yearly / cached_load_quarterly_seed / load_leader_team_yearly_monthly_budgets / load_leader_team_monthly_budgets / load_active_leader_teams) | clear 呼出検証 |
