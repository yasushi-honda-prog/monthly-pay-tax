...
|---|---|---|---|
| `team-budget-eval-monthly` | `0 7 1 * *` | pay-collector `/eval/team-monthly` (OIDC) | 非同期（async=true）|
...
- `test_eval_endpoint.py`: Flask test client、同期/非同期、parameter validation、OIDC 認証
