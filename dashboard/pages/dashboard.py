...
with tab5:
    ...
    if df_cost.empty:
        ...
        def _render_cost_chart(df: pd.DataFrame, x_title: str) -> None:
            ...
            _legend_html = "".join(
                f'<div style="display:flex;align-items:center;margin:2px 0;font-size:0.80rem;white-space:nowrap">'
            ...
            with _col_right:
                st.markdown(
                    f'<div style="display:flex;flex-direction:column;align-items:flex-end;padding-top:6px">'
                    f'{_legend_html}</div>',
                    unsafe_allow_html=True,
                )
